...
🎯 How to Play
Start the game.
Enter a 5-letter word using your physical keyboard or the on-screen keyboard.
Press Enter to submit your guess.
Check the colors of the letters.
Use the feedback to improve your next guess.
You have a maximum of 6 valid guesses.
Guess the solution correctly to win.
If all 6 guesses are used, the game ends and the solution is revealed.
